			...
			<form:form method="POST" commandName="chip"
				...
				<spring:bind path="barcodes">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputBarcodes" placeholder="Barcodes" path="barcodes" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="x1_border">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputX1Border" placeholder="X1 border" path="x1_border" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="x1_total">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputX1Total" placeholder="X1 total" path="x1_total" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="x2_border">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputX2Border" placeholder="X2 border" path="x2_border" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="x2_total">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputX2Total" placeholder="X2 total" path="x2_total" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="y1_border">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputY1Border" placeholder="Y1 border" path="y1_border" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="y1_total">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputY1Total" placeholder="Y1 total" path="y1_total" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
				...
				<spring:bind path="y2_border">
					<div class="control-group ${status.error ? 'error' : ''}">
						...
						<div class="controls">
							<form:input type="text" id="inputY2Border" placeholder="Y2 border" path="y2_border" />
							<span class='help-inline'>${status.errorMessage}</span>
						</div>
					</div>
				</spring:bind>
